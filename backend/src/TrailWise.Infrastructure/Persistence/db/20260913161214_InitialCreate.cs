        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePricePerPerson = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatConfiguration = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    MaintenanceStatus = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassType = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    IncludesFood = table.Column<bool>(type: "boolean", nullable: false),
                    BasePricePerPerson = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                    RequiresAC = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageTiers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageTiers_TourPackages_TourPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TourPackageId = table.Column<Guid>(type: "uuid", nullable: false),
                    PackageTierId = table.Column<Guid>(type: "uuid", nullable: false),
                    GroupSize = table.Column<int>(type: "integer", nullable: false),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: false),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: false),
                    BudgetPerPerson = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_PackageTiers_PackageTierId",
                        column: x => x.PackageTierId,
                        principalTable: "PackageTiers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgentWorkflowRuns_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedBookingId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuideAvailabilities_Bookings_AssignedBookingId",
                        column: x => x.AssignedBookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItinerarySteps_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleAssignments_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgentStepLogs_AgentWorkflowRuns_WorkflowRunId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentStepLogs_WorkflowRunId",
                table: "AgentStepLogs",
                column: "WorkflowRunId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentWorkflowRuns_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_PackageTierId",
                table: "Bookings",
                column: "PackageTierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuideAvailabilities_AssignedBookingId",
                table: "GuideAvailabilities",
                column: "AssignedBookingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItinerarySteps_BookingId",
                table: "ItinerarySteps",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageTiers_TourPackageId",
                table: "PackageTiers",
                column: "TourPackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleAssignments_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleAssignments_VehicleId_StartDate",
                table: "VehicleAssignments",
